...
function ProductList() {
  ...
  // Array containing the plant categories and their details
  const plantsArray = [
    {
            ...
            <a href="#" onClick={(e) => handleCartClick(e)} style={styleA}>
              <h1 className='cart'>
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 256 256" id="IconChangeColor" height="68" width="68">
                  <text x="50%" y="50%" textAnchor="middle" dy=".3em" className="cart" style={{ fill: 'white', fontWeight: 'bold' }} >{totalQuantity}</text>
